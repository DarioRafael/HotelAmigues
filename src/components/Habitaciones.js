    ...
    return (
        <div className="container mx-auto py-40 px-4">
            ...
            {selectedImageIndex !== null && selectedRoom && (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
                    <div className="bg-gray-800 p-4 rounded-lg flex items-center justify-between w-full max-w-4xl">
                        <button
                            onClick={prevImage}
                        ...
                        <img
                            ...
                            alt="Imagen Ampliada"
                            className="max-w-full max-h-[80vh] object-contain"  // Asegura que la imagen se ajuste sin recortarse
                        />
                        <button
                            onClick={nextImage}
                            className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"
                    ...
                    {/* Botón "Cerrar" debajo de la imagen */}
                    <button
                        onClick={closeImageModal}
                        className="absolute bottom-4 bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded w-full max-w-[80vh]"
                    >
                        Cerrar
                    </button>
                </div>
